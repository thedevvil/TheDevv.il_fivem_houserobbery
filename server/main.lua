...
RegisterNetEvent('qb-houserobbery:server:searchCabin', function(cabin, house)
    ...
    if itemFound < 4 then
        ...
        TriggerClientEvent('QBCore:Notify', source, Lang:t("error.emty_box"), 'error')
    end
